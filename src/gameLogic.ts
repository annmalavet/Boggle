...
interface IState {
  board: Board;//initial board selection
...
module gameLogic {
  ...
  export function getInitialState(): IState {
    return {
      board: getInitialBoard(), chosenBoard: null, guessList:null
    };
  }
  ...
  export function createMove(
    ...
    let delta: BoardDelta =  {board:board, guessList:guessList};// { row: row, col: col };
    let state: IState =  { chosenBoard: board, board: boardAfterMove, guessList:guessList };
    return {
